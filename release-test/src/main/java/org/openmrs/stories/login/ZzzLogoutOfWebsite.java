 ...
 */
package org.openmrs.stories.login;
...
public class ZzzLogoutOfWebsite extends Story {

	@Override
    public List<Steps> includeSteps() {
        return asList(new LoginPageSteps(driver), new AdminSteps(driver), new LogoutSteps(driver));
    }
}
